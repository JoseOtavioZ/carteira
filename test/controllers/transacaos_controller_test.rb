...
class TransacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transacao" do
    assert_difference("Transacao.count") do
      post transacaos_url, params: { transacao: { carteira_destino: @transacao.carteira_destino, carteira_origem: @transacao.carteira_origem, id: @transacao.id, tipo_transacao: @transacao.tipo_transacao, valor: @transacao.valor } }
    end
  ...
  test "should update transacao" do
    patch transacao_url(@transacao), params: { transacao: { carteira_destino: @transacao.carteira_destino, carteira_origem: @transacao.carteira_origem, id: @transacao.id, tipo_transacao: @transacao.tipo_transacao, valor: @transacao.valor } }
