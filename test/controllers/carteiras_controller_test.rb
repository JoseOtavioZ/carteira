...
class CarteirasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carteira" do
    assert_difference("Carteira.count") do
      post carteiras_url, params: { carteira: { id: @carteira.id, saldo: @carteira.saldo, usuario: @carteira.usuario } }
    end
  ...
  test "should update carteira" do
    patch carteira_url(@carteira), params: { carteira: { id: @carteira.id, saldo: @carteira.saldo, usuario: @carteira.usuario } }
